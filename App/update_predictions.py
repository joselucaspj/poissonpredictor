...
def get_todays_matches():
    ...
    def download_todays_matches():
        try:
            ...
            df['Date'] = df['datetime'].dt.tz_convert(timezone('America/Sao_Paulo')).dt.strftime('%d/%m/%Y')
...
def main():
    ...
    csv_path = os.path.join(os.path.dirname(__file__), '../data/latest_predictions.csv')
